...
function Nav() {
  ...
  return (
    <nav className={`nav ${scrolled ? 'scrolled' : ''}`}>
      <a href="#top" className="nav-logo">Field Exploration</a>
    ...
    <div id="top" className="hero">
      <div className="hero-left">
        ...
        <p className="hero-desc">
          ...
          documenting supply chain operations, distribution practices, 
  ...
  return (
    <div className="container reveal" ref={ref}>
      <div className="stats-strip">
        ...
        <div className="stat-item">
          <div className="stat-num">{mediaManifest.memberImages.length || 5}</div>
            ...
            <div className="members-grid">
              {mediaManifest.memberImages.map((file, i) => (
                <div key={file} className="member-card">
                  <img src={`/images/members/${file}`} alt={`Member ${i + 1}`} loading="lazy" />
  ...
  return (
    <>
      ...
      <CompanySection
        ...
        observations={[
          { icon: '🆕', title: 'New Arrivals & Limited Edition', desc: 'Seasonal drops drive urgency and inventory turnover at the floor level.' },
          { icon: '📱', title: 'Online-to-Offline (O2O)', desc: 'Order unavailable sizes online in-store — a smart inventory extension.' },
          { icon: '🏷️', title: 'Membership Program', desc: 'Loyalty data enables demand forecasting and personalised promotions.' },
          { icon: '♻️', title: 'Recycling Bins', desc: 'Reverse logistics in action — clothes collected and repurposed.' },
          { icon: '🤖', title: 'Self-Checkout Counter', desc: 'Reduces labour cost and improves throughput at peak hours.' },
          { icon: '🎨', title: 'Brand Collaborations', desc: 'Disney, Marvel, Pokémon, Pop Mart, Mario, Peanuts, Old Chang Kee & more.' },
          { icon: '👔', title: 'Store Sections', desc: 'Men, Women & Kids zones organised by segment for easy navigation.' },
          { icon: '🗺️', title: 'Floor Layout Display', desc: 'Visual merchandising with body displays and floor plan guides product flow.' },
        ]}
      />
      ...
      <CompanySection
        ...
        observations={[
          { icon: '🏗️', title: '2-Floor Layout', desc: 'Floor 2: Showroom with room setups. Floor 1: Small items, plants, warehouse.' },
          { icon: '🛋️', title: 'Experiential Showroom', desc: 'Room setups let customers "live" the product — try sofas, beds, and chairs.' },
          { icon: '📐', title: 'Free Measurement Tools', desc: 'Free measuring tape, notepad & pencil — customers self-measure items.' },
          { icon: '💻', title: 'Digital Store Map', desc: 'No physical floor map — digital kiosk shows real-time item locations.' },
          { icon: '🏭', title: 'In-store Warehouse', desc: 'End-of-floor-1 warehouse with crane. No robots — fully human-powered.' },
          { icon: '🌭', title: 'Low-Cost Food Strategy', desc: '$1 hotdog, $0.50 ice cream — deliberate marketing to increase dwell time.' },
          { icon: '🚌', title: 'Shuttle Bus Service', desc: 'Free shuttle to Tampines & Serangoon MRT — solving last-mile transport.' },
          { icon: '📦', title: 'Self-Pack & Disassembly', desc: 'Self-packing counter and disassembly station aligned with flat-pack design.' },
        ]}
      />
      ...
      <CompanySection
        ...
        observations={[
          { icon: '⚡', title: 'Fast Replenishment', desc: 'New stock arrives twice weekly — intentional scarcity drives urgency.' },
          { icon: '🏷️', title: 'RFID Technology', desc: 'All items tagged with RFID for real-time inventory tracking store-wide.' },
          { icon: '👗', title: 'Visual Merchandising', desc: 'High-contrast display and editorial styling communicates brand identity.' },
          { icon: '🗺️', title: 'Store Flow Design', desc: 'Curated route through the store maximises product exposure time.' },
          { icon: '📦', title: 'Back-of-House Ops', desc: 'Lean stockroom design — items move quickly from delivery to floor.' },
          { icon: '🌍', title: 'Global Sourcing', desc: 'Centralized hub in Arteixo, Spain ships twice weekly to all global stores.' },
        ]}
      />
        ...
        <div className="container">
          <div className="footer-inner">
            ...
            <div className="footer-info">
              Group 1 · PGDM Supply Chain Management<br />
              Retail & Fashion — Lecturer: Mr. Nathan<br />
