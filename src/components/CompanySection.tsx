      ...
      <div className="container">
        ...
        <div className="reveal" ref={headerRef}>
          ...
          <div className="company-bar">
            <span className={`company-badge ${badgeClass[company]}`}>
              {company}
            </span>
        ...
        {/* ── Photo Gallery ── */}
        <div className="reveal gallery-page" ref={galleryRef}>
          <div className="video-section-label">Photo Gallery</div>

          <Gallery folder={`images/${company}`} images={images} />

          {videos.length > 0 && (
            <div className="video-section">
              <div className="video-section-label">Video Gallery</div>

              <VideoGallery folder={`videos/${company}`} videos={videos} />
            </div>
          )}
        </div>
      </div>
